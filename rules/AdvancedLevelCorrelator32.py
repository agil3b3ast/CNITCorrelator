...
LEVEL = 3
print("{}, Layer {} Correlation".format("AdvancedLevelCorrelator2", LEVEL))
context_id = "{}Layer{}Correlation".format("AdvancedLevelCorrelator2", LEVEL)


class AdvancedLevelCorrelator32(Plugin):
    ...
    def run(self, idmef):
        ...
        if ctx is None:
         ...
         ctx.set("alert.classification.text", "MyFirstAdvancedLevelScan32")
        ...
        if ctx.getWindowHelper().checkCorrelationWindow():
          ...
          ctx.alert()
          print("Alert Finished AdvancedLevelCorrelator32")
