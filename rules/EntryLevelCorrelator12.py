...
LEVEL = 1
print("{}, {} Level Correlation2".format("EntryLevelCorrelator", LEVEL))
#The context should be unique, it's better add the class name since we know it's unique
context_id = "{}Layer{}Correlation2".format("EntryLevelCorrelator", LEVEL)
...
class EntryLevelCorrelator12(Plugin):
    def run(self, idmef):
        ...
        if ctx is None:
         ...
         ctx.set("alert.classification.text", "MyFirstEntryLevelScan12")
